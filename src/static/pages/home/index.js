...
function _renderProductCards() {
  _renderProductCards = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var listContainer, menuItems, menuList;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function addToCart(item) {
  ...
  if (!existingItem) {
    ...
    notiflix__WEBPACK_IMPORTED_MODULE_1___default().Notify.success("Item added to cart");
...
function handleRemoveButtonClick(button) {
  ...
  localStorage.setItem("cartItems", JSON.stringify(cartItems));
  row.remove();
  (0,_header__WEBPACK_IMPORTED_MODULE_1__.updateCartCounter)(); //Оновлюємо візуально кількість у корзині
  updateTotalPrice();
}
...
/* harmony import */ var _components_cartModal_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/cartModal/index */ "../components/cartModal/index.js");
/* harmony import */ var _components_footer_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../components/footer/index */ "../components/footer/index.js");
/* harmony import */ var _page_components_home_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../page-components/home/index */ "../page-components/home/index.js");
// base styles
