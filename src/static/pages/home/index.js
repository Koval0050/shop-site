...
function addToCart(item) {
  ...
  if (!existingItem) {
    ...
    notiflix__WEBPACK_IMPORTED_MODULE_1___default().Notify.info("Item already exists in the cart");
  }
}
renderProductCards();
...
var cartTableBody = document.querySelector(".cart-table__body");
...
function handleQuantityButtonClick(button) {
  ...
  var row = button.closest(".cart-table__row");
  var quantityElement = row.querySelector(".quantity");
  var quantity = parseInt(quantityElement.textContent);
  var rowIndex = cartItems.findIndex(function (item) {
    return item.title === row.querySelector(".cart-table__cell--title").textContent;
  });
  if (action === "increase") {
    quantity++;
    console.log("+1");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  renderCartItems();
  updateTotalPrice();
  var cartTableBody = document.querySelector(".cart-table");
  cartTableBody.addEventListener("click", function (event) {
