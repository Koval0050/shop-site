      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          listContainer.addEventListener("click", function (event) {
            var addToCartBtn = event.target.closest(".list-item__card-btn");
            if (addToCartBtn) {
              var itemId = addToCartBtn.closest(".cards-list__item").id;
...
function addToCart(item) {
  ...
  if (!existingItem) {
    ...
    localStorage.setItem("cartStorageItems", JSON.stringify(cartItems));
    notiflix__WEBPACK_IMPORTED_MODULE_1___default().Notify.success("Number of ".concat(item.title, " in the basket: ").concat(existingItem.quantity));
    (0,_header__WEBPACK_IMPORTED_MODULE_3__.updateCartCounter)();
  }
}
renderProductCards();
